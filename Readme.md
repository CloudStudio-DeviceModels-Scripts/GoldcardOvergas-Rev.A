...
# Parsing + Configuration Script – Goldcard Overgas - Rev. A

This **Parsing + Configuration** script is designed for the **Goldcard Overgas** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Goldcard Overgas Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Goldcard Overgas** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
